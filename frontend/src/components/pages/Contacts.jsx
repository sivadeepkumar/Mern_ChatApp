            ...
            {contacts.map((contact, index) => (
                ...
                >
                  <div className="avatar">
                    <img
                      src={`data:image/svg+xml;utf8,${encodeURIComponent(contact.avatarImage)}`}
                      alt=""
                    />
                  </div>
          ...
          <div className="current-user">
            <div className="avatar">
              <img
                ...
                src={`data:image/svg+xml;utf8,${encodeURIComponent(currentUserImage)}`}
                alt="avatar"
              />
            </div>
            <div className="username">
